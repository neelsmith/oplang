...
/**
* An implementation of the Comparator interface that sorts OPStrings
* 
*/
class OPComparator implements Comparator {

    /** Ordered map of beta-code alphabetic characters for use in comparator */
  static def betaOrder = 
  [ 
    0 : 'a', 1: 'b',2:'g',3:'d',4:'e',5:'z',6:'h',7:'q',8:'i',9:'k',
    10:'l',11:'m',12:'n',13:'c',14:'o',15:'p',16:'r',17:'s',18:'t', 19:'u',
    20:'f',21:'x',22:'y',23:'w'
  ]
